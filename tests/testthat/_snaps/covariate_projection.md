# covariate projection - no standardization
    ...
    Code
      perform_covariate_projection(X_aug = mtcars, standardize = FALSE, covariates = c(
        "hp", "mpg"))
    Output
      ...
      3 Residual_variance 0.6386901    0.000 -7.105427e-15 3641.924 0.14863797
...
---
    ...
    Code
      perform_covariate_projection(X_aug = mtcars, standardize = TRUE, covariates = c(
        "hp", "mpg"))
    Output
      $residual_variance_df
                                  cyl hp mpg         disp        drat          wt
      ...
      3 Residual_variance 0.2002467  0 1.110223e-16 0.2370921 0.5199289 0.2466235
